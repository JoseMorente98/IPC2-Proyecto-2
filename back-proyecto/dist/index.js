...
var pregunta_router_1 = __importDefault(require("./router/pregunta.router"));
var respuesta_router_1 = __importDefault(require("./router/respuesta.router"));
var asistencia_router_1 = __importDefault(require("./router/asistencia.router"));
var publicacion_router_1 = __importDefault(require("./router/publicacion.router"));
...
server.app.use(api, pregunta_router_1.default);
server.app.use(api, respuesta_router_1.default);
server.app.use(api, asistencia_router_1.default);
server.app.use(api, publicacion_router_1.default);
