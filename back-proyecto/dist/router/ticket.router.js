...
ticket.get('/ticket/:id', ticket_controller_1.default.getInstance().getSingle);
ticket.get('/ticket/usuario/:id', ticket_controller_1.default.getInstance().getByUsuario);
