...
@Component({
  selector: 'app-publi-estudiante',
  templateUrl: './publi-estudiante.page.html',
  styleUrls: ['./publi-estudiante.page.scss'],
})
export class PubliEstudiantePage implements OnInit {
  parameter:any;
  search:any;
  table:any[];
