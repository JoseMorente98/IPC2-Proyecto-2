...
@Component({
  selector: 'app-mensaje-d-estudiante',
  templateUrl: './mensaje-d-estudiante.page.html',
  styleUrls: ['./mensaje-d-estudiante.page.scss'],
})
export class MensajeDEstudiantePage implements OnInit {
  mensajes:any [];
  parameter:any;
